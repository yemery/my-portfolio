    ...
    <div className="w-full h-full flex flex-col">
      <div className="flex-1 h-full flex items-center justify-center max-w-2xl m-auto ">
        <p className="text-center text-base md:text-xl">
          ...
          free to reach out by emailing me directly{" "}
      ...
      <div className="text-center italic text-xs p-3 ">
        <p>© {new Date().getFullYear()} Meryem Ajmani . All rights reserved.</p>
        <p>
          {" "}
          Some designs used were adapted from{" "}
          <span>
            <Here email="https://stormix.co/" />{" "}
          </span>
        </p>
      </div>
    </div>
